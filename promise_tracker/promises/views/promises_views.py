...
class PromiseCreateView(VerifiedLoginRequiredMixin, RoleBasedAccessMixin, BaseFormView):
    ...
    def form_valid(self, request, form, *args, **kwargs):
        ...
        promise = service.create_promise(
            ...
            party_id=form.cleaned_data["party"].id if form.cleaned_data["party"] else None,
            union_id=form.cleaned_data["union"].id if form.cleaned_data["union"] else None,
...
class PromiseDetailView(VerifiedLoginRequiredMixin, RoleBasedAccessMixin, HandleErrorsMixin, View):
